...
const MiddleSection = () => {
    return (
        <div className="flex flex-col md:flex-row gap-5 px-5 my-8"   >
            <div className="md:w-3/4 flex flex-col gap-2 lg:gap-10 p-5 lg:p-10 bg-[#161616] rounded-xl shadow-2xl" data-aos="zoom-in">
           
          <div className="space-y-2">
            <p className="text-[#a1a0a0] uppercase">Specialization</p>
            <h2 data-aos="fade-right" className="uppercase font-bold md:text-2xl">
             My Skills
            </h2>
          </div>
          <figure className="">
           <div className="bg-[#161616] rounded-3xl shadow-2xl my-2">
            <Marquee pauseOnHover>
              ...
              <Cart img={js} title={'HTML'} subTitle={'80%'}></Cart>
              <Cart img={react} title={'react'} subTitle={'75%'}></Cart>
              <Cart img={mongodb} title={'HTML'} subTitle={'50%'}></Cart>
              <Cart img={css} title={'HTML'} subTitle={'80%'}></Cart>
              <Cart img={js} title={'HTML'} subTitle={'80%'}></Cart>
            </Marquee>
          </div>
           <div className="flex justify-end">
            ...
            <div className="md:w-1/4 flex flex-col gap-8 p-5 lg:p-10 bg-[#161616] rounded-xl shadow-2xl">
